...
?>
<!-- <div class="w-full">
<p class="woocommerce-result-count text-white text-xl font-bold !ml-8 py-auto" role="alert" aria-relevant="all" <?php echo ( empty( $orderedby ) || 1 === intval( $total ) ) ? '' : 'data-is-sorted-by="true"'; ?>>
	<?php
