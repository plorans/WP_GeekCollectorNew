...
@section('content')
    ...
    @php
        ...
        if (trn_get_option('uses_draws')) {
            $form_fields = trn_array_merge_after_key($form_fields, 'losses', [
                'draws' => [
                    'id' => 'draws',
    ...
    <div class="ml-auto mt-10 max-w-7xl text-white">
        <h1 class="trn-mb-4 text-4xl">{{ esc_html_e('Edit Competitor', 'tournamatch') }}</h1>
        <div class="flex w-1/2 flex-col rounded-lg bg-[#1a1a1a] p-6 shadow-lg">
            <div>
                {!! trn_user_form($form, $competitor) !!}
                ...
                @php
                    ...
                    wp_register_script('trn-edit-competitor', plugins_url('/tournamatch/dist/js/edit-competitor.js'), ['tournamatch'], '3.23.0', true);
